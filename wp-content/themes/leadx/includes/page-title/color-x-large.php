...
$page_subtitle = get_post_meta( $id, 'leadx_post_page_subtitle', true );
...
$page_subtitle_color = get_post_meta( $id, 'leadx_post_page_subtitle_color', true );
...
$shortcodeColor .= '</div><div class="row"><div class="col-xs-12">' . leadx_breadcrumbs() . '</div></div></div></div>';
