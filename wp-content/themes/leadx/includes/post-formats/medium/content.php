...
<div class="content-img">
    ...
    if ( has_post_thumbnail() ) { ?>
        <div class="col-xs-12 col-sm-4">
            <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__('Permalink to %s', 'leadx'), the_title_attribute('echo=0') ); ?>" rel="bookmark">
                <?php the_post_thumbnail('leadx-img-size-blog'); ?>
            </a>    
        </div>
