 ...
 * Header Stacked
 */
$topbar_right_content = get_theme_mod( 'leadx_topbar_right_content', 'text' );
$nav_text_align = get_theme_mod( 'leadx_nav_text_align', 'text-left' );
?>
            ...
            <div class="container">
                <div class="row bottom-row v-align">
                    <div class="col-xs-12 <?php echo esc_attr($nav_text_align); ?>">
                        <?php
                        $page_menu = get_post_meta( $id, 'leadx_post_header_menu', true );
                        if ($page_menu != '') {
                            wp_nav_menu( array(
                                'theme_location' => 'main',
                                'menu'              => $page_menu,
