...
$logo = get_theme_mod( 'leadx_logo_mobile', get_template_directory_uri() . '/img/logo_small.png' );
$logo2x = get_theme_mod( 'leadx_logo2x_mobile', get_template_directory_uri() . '/img/logo_small2x.png' );
if( is_ssl() ) {
		...
		<div class="row">
		    <div class="col-xs-12">
    			...
    			<form action="<?php echo esc_url(home_url()) ?>" method="GET">
    	      		<input type="text" name="s" value="" placeholder="<?php echo esc_html__('Search..', 'leadx') ?>"  autocomplete="off" />
    			</form> 
    			<?php } ?>
		    </div>
		</div>
