...
<div class="header-cart">
    <a href="<?php echo esc_url($cart_url); ?>" class="cart">
        ...
        <span class="title"><?php esc_html_e('Shopping Cart','leadx'); ?></span>
    </a>
    
    <div class="function">
        <div class="widget">
        
            <h6 class="title"><?php esc_html_e('Shopping Cart','leadx'); ?></h6>
            ...
            <div class="cart-controls">
                <a class="ttbase-button small btn-primary <?php echo get_theme_mod('leadx_button_style', 'style-2'); ?>" href="<?php echo esc_url($checkout_url); ?>"><?php esc_html_e('Checkout','leadx'); ?></a>
                <div class="pull-right">
                    <span class="cart-total"><?php esc_html_e('Total','leadx'); ?>: </span>
