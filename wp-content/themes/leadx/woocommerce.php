...
get_header();
$top_padding = get_post_meta(get_the_ID(), 'leadx_post_top_padding', true);
$bottom_padding = get_post_meta(get_the_ID(), 'leadx_post_bottom_padding', true);
?>
    ...
    <div class="container">
        <div class="row">
        	...
        	if(is_product()){
        		...
        		$sidebar = get_theme_mod('leadx_wc_single_layout', 'no-sidebar');
        	...
        	// Main Shop Layout
                ...
                $main_sidebar = get_theme_mod('leadx_wc_main_layout', 'left-sidebar');
        	...
        	?>
        		...
        		<div id="primary" class="<?php echo esc_attr($wooclass); ?> <?php if(!is_product()){ echo esc_attr(get_theme_mod('leadx_wc_columns', 'columns-3')); } ?>">
        			<?php woocommerce_content(); ?>
        		</div> <!-- end content -->
