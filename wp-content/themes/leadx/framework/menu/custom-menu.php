...
add_filter( 'wp_setup_nav_menu_item', 'leadx_add_custom_nav_fields' );

// save menu custom fields
add_action( 'wp_update_nav_menu_item', 'leadx_update_custom_nav_fields', 10, 3 );

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'leadx_edit_walker', 10, 2 );


function leadx_add_custom_nav_fields( $menu_item ) {
 ...
 *
*/
function leadx_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
 ...
 *
*/
function leadx_edit_walker($walker,$menu_id) {

	return 'LeadX_Walker_Nav_Menu_Edit';
...
if (!class_exists('leadx_header_walker_nav_menu')) {
	class leadx_header_walker_nav_menu extends Walker_Nav_Menu {
