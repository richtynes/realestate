...
class LeadX_Sanitize_Data {

    /**
     * Parses data
     *
     */
    public function leadx_parse_data( $data, $type ) {
...
// Helper function runs the LeadX_Sanitize_Data class
function leadx_sanitize_data( $data = '', $type = '' ) {
    if ( $data && $type ) {
        $class = new LeadX_Sanitize_Data();
        return $class->leadx_parse_data( $data, $type );
    }
}