...
// Start Class
if ( ! class_exists( 'LeadX_Image_Resize' ) ) {

    class LeadX_Image_Resize {
        ...
        public function __construct() {
            $this->leadx_retina_enabled = get_theme_mod( 'leadx_retina', false );
            $this->leadx_retina_enabled = apply_filters( 'leadx_image_resize_retina', $this->leadx_retina_enabled );
        }
         ...
         */
        public function leadx_process( $args ) {


            // Args must be an array
            if ( ! is_array( $args ) ) {
                print_r( esc_attr__('Fatal Error: Image resize args are not an array, you must update your template files.', 'leadx' ));
                return false;
            }
            ...
            if ( $crop && get_theme_mod( 'leadx_image_resizing', true ) ) {
                if ( is_array( $crop ) ) {
...
// Helper function for resizing images using the LeadX_Image_Resize class
if ( ! function_exists( 'leadx_image_resize' ) ) {
    function leadx_image_resize( $args ) {
        $class = new LeadX_Image_Resize;
        return $class->leadx_process( $args );
    }
}