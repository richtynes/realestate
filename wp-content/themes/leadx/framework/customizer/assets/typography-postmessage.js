...
wp.customize("button_typography[font-weight]", function(e) {
    $currentVal = $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("font-weight");
    e.bind(function(e) {
        if (e) {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("font-weight", e);
        } else {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("font-weight", "");
        }
    });
});
wp.customize("button_typography[font-style]", function(e) {
    $currentVal = $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("font-style");
    e.bind(function(e) {
        if (e) {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("font-style", e);
        } else {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("font-style", "");
        }
    });
});
wp.customize("button_typography[font-size]", function(e) {
    $currentVal = $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("font-size");
    e.bind(function(e) {
        if (e) {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("font-size", parseInt(e, 10) + "px");
        } else {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("font-size", "");
        }
    });
});
wp.customize("button_typography[color]", function(e) {
    $currentVal = $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("color");
    e.bind(function(e) {
        if (e) {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("color", e);
        } else {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("color", "");
        }
    });
});
wp.customize("button_typography[line-height]", function(e) {
    $currentVal = $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("line-height");
    e.bind(function(e) {
        if (e) {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("line-height", e);
        } else {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("line-height", "");
        }
    });
});
wp.customize("button_typography[letter-spacing]", function(e) {
    $currentVal = $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("letter-spacing");
    e.bind(function(e) {
        if (e) {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("letter-spacing", parseInt(e, 10) + "px");
        } else {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("letter-spacing", "");
        }
    });
});
wp.customize("button_typography[text-transform]", function(e) {
    $currentVal = $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("text-transform");
    e.bind(function(e) {
        if (e) {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("text-transform", e);
        } else {
            $(".btn-primary, .menu-button, .gform_button, .woocommerce input.button.alt, input[type=submit], .nav-menu li.menu-button a").css("text-transform", "");
        }
    });
});
